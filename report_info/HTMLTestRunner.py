...
<button class="btn btn-default" onclick='javascript:showCase(0)'>摘要</button>
...
class _TestResult(TestResult):
    ...
    def addFailure(self, test, err):
        ...
        if self.verbosity > 1:
            ...
            sys.stderr.write(str(test))
            sys.stderr.write('\n')
            failcasename.append(str(test)+str(test.failureException))
        else:
            sys.stderr.write('F')
...
class HTMLTestRunner(Template_mixin):
    ...
    def sortResult(self, result_list):
        ...
        for n, t, o, e in result_list:
            cls = t.__class__
            if not rmap.__contains__(cls):               #has_key在python3修改
                rmap[cls] = []
                classes.append(cls)
   ...
   #         desc = desc.decode('utf-8')                        #已经是解码的了
